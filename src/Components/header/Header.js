    ...
    return (
      <React.Fragment>
        <div
          ...
          style={{
            backgroundColor:
              HeaderStyle == 'transparent' ? 'transparent' : '#f1f1f1f1',
          }}
        >
        ...
        <Modal isOpen={isLoginModalOpen} style={customStyles}>
          ...
          <form className="form">
            ...
            <div className="text-center">
              <input type="button" className="btn btn-primary pagelog" onClick={this.loginHandler} value="Login" />
              <button className="btn cancel1" onClick={this.cancelLoginHandler}>Cancel</button>
            </div>
            <div className="mt-4">
        ...
        <Modal isOpen={isSignupModalOpen} style={customStyles}>
          ...
          <form className="form">
            ...
            <div className="text-center">
              <input type="button" className="btn btn-primary pagesign" onClick={this.signupHandler} value="Signup" />
              <button className="btn cancel2" onClick={this.cancelSignupHandler}>Cancel</button>
            </div>
            <div className="mt-4">
